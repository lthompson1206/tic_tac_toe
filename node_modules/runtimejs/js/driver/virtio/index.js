...
'use strict';
const virtioNet = require('runtimejs/js/driver/virtio/net');
const virtioBlk = require('runtimejs/js/driver/virtio/blk');
const virtioRNG = require('runtimejs/js/driver/virtio/rng');
